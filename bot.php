			...
			if(isset($update->message)){
              ...
              $bot->sendphoto([ 'chat_id'=>$chatId,
                  'photo'=>"https://t.me/K_W_0",
                   'caption'=>'🍓 𝒘𝒆𝒍𝒍𝒄𝒐𝒎𝒆 ๛ Muhammed Hamadi bot🌰',
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          [['text'=>'تسجيل حساب 🌚','callback_data'=>'login']],
                       [['text'=>"اضغط لمراسله المطور للابلاغ عن مشاكل 🇮🇶", 'url'=>"https://t.me/K_W_0"]],
                       [['text'=>"اضغط لمراسله المطور الاساسي🥺", 'url'=>"https://t.me/K_W_0"]],
                      ]
                  ])
              ]);   
          } 
if($text == '/help'){
              ...
              'caption'=>'طرق السحبب🤘😂',
                      'reply_markup'=>json_encode([
                      'inline_keyboard'=>[                       
                       [['text'=>"🇪🇬غط لمراسله المطور للابلاغ عن مشاكل 🇪🇬", 'url'=>"https://t.me/K_W_0"]],
                       ]
                       ])
                       ]);
...
اضغط في الاسفل لمراسله المطور 👇",
							'reply_markup'=>json_encode([
                  'inline_keyboard'=>[
                      [['text'=>'اضغط لمراسله المطور 🗣','url'=>'https://t.me/K_W_0']]
                  ]
							])
					]);
				}
